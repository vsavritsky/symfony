...
class BMBackupManagerExtension extends Extension
{
    ...
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        $managerIdMap = [
            ...
            'Webdav' => 'backup_manager.filesystems.webdav_filesystem',
        ];
    ...
    private function validateStorage(array $config)
    {
        $requirements = [
            ...
            'Gcs' => ['package' => 'superbalist/flysystem-google-storage:^1.0', 'test' => GoogleStorageAdapter::class],
            'Webdav' => ['package' => 'league/flysystem-webdav:^6.0', 'test' => WebDAVAdapter::class],
        ];
